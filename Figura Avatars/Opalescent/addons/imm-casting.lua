...
RIGHTARMPATH = models.opal.root.RightArm
LEFTARMPATH = models.opal.root.LeftArm
RIGHTITEMPATH = models.opal.root.RightArm.RightItemPivot
LEFTITEMPATH = models.opal.root.LeftArm.LeftItemPivot
