...
LightBluePage:newAction()
    :title("Summon Strays"):item("minecraft:tipped_arrow{Potion:\"minecraft:slowness\"} ")
    :onLeftClick(function() SendArcana("charge:strays:5", "castArmsOut2", "light_blue") end)
...
MagentaPage:newAction()
    :title("Brush Shift: Celestial Pocketwatch"):item("spectrum:celestial_pocketwatch")
    :onLeftClick(function() SendArcana("brush-shift:celestial pocketwatch", "castArmsOut1", "magenta") end)
...
PurplePage:newAction()
    :title("Read & Cast"):item("hexcasting:spellbook")
    :onLeftClick(function() SendArcana("cad", "castArmsIn1", "purple") end)
...
LightGrayPage:newAction()
    :title("Brush Shift: Pocket Computer"):item("computercraft:pocket_computer_advanced")
    :onLeftClick(function() SendArcana("brush-shift:pocket computer", "castArmsIn1", "light_gray") end)
